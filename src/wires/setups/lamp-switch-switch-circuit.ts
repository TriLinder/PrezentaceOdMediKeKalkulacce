...
export class LampSwitchSwitchCircuitSetup extends WireSetup {
    constructor() {
        ...
        const rightSwitchComponent = new SwitchComponent(new Coordinates((3840 / 2 - 350 / 2) + 1000, 2160 / 2 - 350 / 2), new Size(350, 350), [powerSourceComponent.getOutput(0)]);
        const leftSwitchComponent = new SwitchComponent(new Coordinates((3840 / 2 - 350 / 2) - 1000, 2160 / 2 - 350 / 2), new Size(350, 350), [rightSwitchComponent.getOutput(0)]);
